...
type DialPlatformMethod int64

const (
	DialPlatformMethod_Dig           DialPlatformMethod = 0
	DialPlatformMethod_DigAndPing    DialPlatformMethod = 1
	DialPlatformMethod_DigAndHttp    DialPlatformMethod = 2
	DialPlatformMethod_DigAndWeb     DialPlatformMethod = 3
	DialPlatformMethod_DigAndVideo   DialPlatformMethod = 4
	DialPlatformMethod_FocusDomain   DialPlatformMethod = 5
	DialPlatformMethod_RefreshCache  DialPlatformMethod = 6
	DialPlatformMethod_DomainSchedul DialPlatformMethod = 7
)

func (p DialPlatformMethod) String() string {
	switch p {
	case DialPlatformMethod_Dig:
		return "Dig"
	case DialPlatformMethod_DigAndPing:
		return "DigAndPing"
	case DialPlatformMethod_DigAndHttp:
		return "DigAndHttp"
	case DialPlatformMethod_DigAndWeb:
		return "DigAndWeb"
	case DialPlatformMethod_DigAndVideo:
		return "DigAndVideo"
	case DialPlatformMethod_FocusDomain:
		return "FocusDomain"
	case DialPlatformMethod_RefreshCache:
		return "RefreshCache"
	case DialPlatformMethod_DomainSchedul:
		return "DomainSchedul"
	}
	return "<UNSET>"
}

func DialPlatformMethodFromString(s string) (DialPlatformMethod, error) {
	switch s {
	case "Dig":
		return DialPlatformMethod_Dig, nil
	case "DigAndPing":
		return DialPlatformMethod_DigAndPing, nil
	case "DigAndHttp":
		return DialPlatformMethod_DigAndHttp, nil
	case "DigAndWeb":
		return DialPlatformMethod_DigAndWeb, nil
	case "DigAndVideo":
		return DialPlatformMethod_DigAndVideo, nil
	case "FocusDomain":
		return DialPlatformMethod_FocusDomain, nil
	case "RefreshCache":
		return DialPlatformMethod_RefreshCache, nil
	case "DomainSchedul":
		return DialPlatformMethod_DomainSchedul, nil
	}
	return DialPlatformMethod(0), fmt.Errorf("not a valid DialPlatformMethod string")
}

func DialPlatformMethodPtr(v DialPlatformMethod) *DialPlatformMethod { return &v }

func (p DialPlatformMethod) MarshalText() ([]byte, error) {
	return []byte(p.String()), nil
}

func (p *DialPlatformMethod) UnmarshalText(text []byte) error {
	q, err := DialPlatformMethodFromString(string(text))
	if err != nil {
		return err
	}
	*p = q
...
func (p *IpResult_) readField5(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.VideoResults = append(p.VideoResults, _elem4)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *FocusDomainResult_) readField3(iprot thrift.TProtocol) error {
	...
	p.Results = tSlice
	for i := 0; i < size; i++ {
		_elem5 := &FocusDomainResultItem{}
		if err := _elem5.Read(iprot); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem5), err)
		}
		p.Results = append(p.Results, _elem5)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *DomainTarget) readField7(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Results = append(p.Results, _elem7)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *AnalysisResult_) readField5(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Totals = append(p.Totals, _elem8)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
